...
const CONTENT = {
  it: {
    ...
    installSteps: [
      { title: 'Scarica', text: `Scarica direttamente il file DMG ufficiale della versione ${MAC_APP_VERSION}.` },
    ...
    companyNote: `Versione Mac ${MAC_APP_VERSION} · Dati societari e informazioni legali in aggiornamento.`,
  },
  en: {
    ...
    installSteps: [
      { title: 'Download', text: `Download the official DMG for version ${MAC_APP_VERSION} directly.` },
    ...
    companyNote: `Mac version ${MAC_APP_VERSION} · Company details and legal information are being updated.`,
  },
} as const;
