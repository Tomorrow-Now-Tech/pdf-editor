...
const CONTENT = {
  it: {
    ...
    installSteps: [
      { title: 'Scarica', text: 'Scarica direttamente il file DMG ufficiale della versione 1.7.0.' },
    ...
    companyNote: 'Versione Mac 1.7.0 · Dati societari e informazioni legali in aggiornamento.',
  },
  en: {
    ...
    installSteps: [
      { title: 'Download', text: 'Download the official DMG for version 1.7.0 directly.' },
    ...
    companyNote: 'Mac version 1.7.0 · Company details and legal information are being updated.',
  },
} as const;
